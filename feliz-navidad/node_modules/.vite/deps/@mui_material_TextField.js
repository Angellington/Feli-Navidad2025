...
var TextareaAutosize = React41.forwardRef(function TextareaAutosize2(props, forwardedRef) {
  const {
    onChange,
    maxRows,
    minRows = 1,
...
var OutlinedInput = React50.forwardRef(function OutlinedInput2(inProps, ref) {
  ...
  return (0, import_jsx_runtime24.jsx)(InputBase_default, {
    ...
    renderSuffix: (state) => (0, import_jsx_runtime24.jsx)(NotchedOutlineRoot2, {
      ...
      label: label != null && label !== "" && fcs.required ? _React$Fragment || (_React$Fragment = (0, import_jsx_runtime24.jsxs)(React50.Fragment, {
        children: [label, " ", "*"]
      })) : label,
...
function FocusTrap(props) {
  ...
  const ignoreNextEnforceFocus = React65.useRef(false);
  const sentinelStart = React65.useRef(null);
  const sentinelEnd = React65.useRef(null);
  const nodeToRestore = React65.useRef(null);
  const reactFocusEventTarget = React65.useRef(null);
  const activated = React65.useRef(false);
  const rootRef = React65.useRef(null);
  const handleRef = useForkRef(getReactElementRef(children2), rootRef);
  const lastKeydown = React65.useRef(null);
  React65.useEffect(() => {
  ...
  return (0, import_jsx_runtime32.jsxs)(React65.Fragment, {
    children: [(0, import_jsx_runtime32.jsx)("div", {
      tabIndex: open ? 0 : -1,
      onFocus: handleFocusSentinel,
      ref: sentinelStart,
      "data-testid": "sentinelStart"
    }), React65.cloneElement(children2, {
      ref: handleRef,
      onFocus
...
var Portal = React66.forwardRef(function Portal2(props, forwardedRef) {
  const {
    children: children2,
    container,
    disablePortal = false
  } = props;
  const [mountNode, setMountNode] = React66.useState(null);
  const handleRef = useForkRef(React66.isValidElement(children2) ? getReactElementRef(children2) : null, forwardedRef);
  useEnhancedEffect_default(() => {
    if (!disablePortal) {
  ...
  if (disablePortal) {
    if (React66.isValidElement(children2)) {
      const newProps = {
        ref: handleRef
      };
      return React66.cloneElement(children2, newProps);
    }
    return children2;
  }
...
var Menu = React73.forwardRef(function Menu2(inProps, ref) {
  ...
  let activeItemIndex = -1;
  React73.Children.map(children2, (child, index) => {
...
var NativeSelectInput = React74.forwardRef(function NativeSelectInput2(props, ref) {
  ...
  return (0, import_jsx_runtime39.jsxs)(React74.Fragment, {
...
var Select = React77.forwardRef(function Select2(inProps, ref) {
  ...
  return (0, import_jsx_runtime42.jsx)(React77.Fragment, {
    children: React77.cloneElement(InputComponent, {
